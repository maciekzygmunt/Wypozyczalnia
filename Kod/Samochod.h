...
class Samochod
{
	public:
		...
		* <p>
		* Metoda pyta klienta o dane rezerwacji, a nastêpnie wyswietla jej koszt. 
		* Mozliwe jest dokonanie rezerwacji jedynie na rok 2022.
		* Posiada konrole poprawnosci wprowadzanej daty.
